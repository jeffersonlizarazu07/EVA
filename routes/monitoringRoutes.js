...
router.get('/monitoring/user/:userId/form/:formId', monitoringController.getMonitoringByUserAndForm); //Obtener monitorización del formulario en cas de que exista
