...
import {
  Box,
  MenuItem,
  Button, Typography, Card, CardContent, IconButton
    ...
    const calcularTopMonitor = async () => {
      try {
        ...
        response.data.data.forEach((form) => {
          const plantilla = plantillaMonitor.filter(p => p.nombre_form === form.title);
    ...
    agrupadoArray.forEach((i) => {
      ...
      if (!agrupadoListar[key]) {
        agrupadoListar[key] = {
          ...
          respuestas: agrupadoArray.filter(x => x.nombre_form === i.nombre_form).length,
          agentes: []
        };
      }
      ...
      <section>
        <Box className="container cards-EVA">
          <Box className="row">
            ...
            {/* OPCION MODO GRID */}
            {viewMode === "grid" && (
              <Box className="cards-group text-center col-lg-8" id="grid-mode">
                <Box className="row m-3">
                  <Box className="row d-flex">
                    <Box className="col-8">
                      <Typography className="text-start p-2 fw-bolder m-2 w-100 tituloCardGroup" variant="h5">
                        {t("qualitySite.Quality_system")}
                      </Typography>
                    </Box>
                    <Box className="col-4">
                      <Typography className="mt-4 flex-shrink-1 text-end date fechaCardGroup" variant="h5">
                  ...
                  <Box className="row d-flex">
                    <Box className="col-2 text-center">
                      <Typography className="cardElement" variant="h4">{conteoDeAgentes}</Typography>
                    </Box>
                    <Box className="col-3 col-lg-2 text-end">
                      <Typography className="cardElement" variant="h4">{conteoDeFormulario}</Typography>
                    </Box>
                  </Box>
                  <Box className="row">
                    <Box className="col-2 text-center">
                      <Typography className="cardElement" variant="h6">{t("qualitySite.Agents")}</Typography>
                    </Box>
                    <Box className="col-8 ms-3 col-lg-4 text-center">
                      <Typography className="cardElement" variant="h6">{t("qualitySite.Monitoring_forms")}</Typography>
                    </Box>
                  </Box>
                </Box>
                    ...
                    <Card className="card card1">
                      <CardContent className="card-body d-grid">
                        ...
                        <Box className="row">
                          <Box className="col-12">
                            <a href="./agent_list">
                              <Button sx={{color:"#ffffff", border:"1px solid #ffffff", borderRadius:"15px"}} id="card-btn-1">
                  ...
                  <Box className="col-lg">
                    <Card className="card card2">
                      <CardContent className="card-body d-grid">
                        <Box className="row">
                          <Box className="col-12 card-title">
                            <span>{t("qualitySite.Monitoring_forms_to_the_agent")}</span>
                          </Box>
                        </Box>
                        <Box className="row">
                          <Box className="col-12">
                        ...
                        <Box className="row button-container">
                          <Box className="col-12">
                            <Button className="card-btn check" sx={{color:"#ffffff", border:"1px solid #ffffff", borderRadius:"15px"}} onClick={() => navigate("/forms")}>
                  ...
                  <Box className="col-lg">
                    <Card className="card card3">
                      <CardContent className="card-body d-grid">
                        <Box className="row">
                          <Box className="col-12 card-title">
                            <span>{t("qualitySite.Monitoring_forms_report_to_the_agent")}</span>
                          </Box>
                        </Box>
                        <Box className="row">
                          <Box className="col-12">
                        ...
                        <Box className="row button-container">
                          <Box className="col-12">
                            <Button className="card-btn check" sx={{color:"#ffffff", border:"1px solid #ffffff", borderRadius:"15px"}} onClick={() => navigate("/forms_report")}>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                      ...
                      <li style={{ marginBottom: "10px" }}>
                        <Box className="list-item item-1 d-flex justify-content-between align-items-center">
                          <Box className="col-6 col-lg-4">
                            <Typography className="text-white fw-bolder" variant="h6">
                          ...
                          <Box className="col col-lg-3">
                            <Button className="card-btn" sx={{color:"#ffffff", border:"1px solid #ffffff", borderRadius:"15px"}} onClick={() => navigate("/agent_list")}>
                              {t("qualitySite.Agents_list")}
                            </Button>
                          </Box>
                        </Box>
                      ...
                      <li style={{ marginBottom: "10px" }}>
                        <Box className="list-item item-2 d-flex justify-content-between align-items-center">
                          ...
                          <Box className="col-lg-4 col-7 d-flex justify-content-center" id="content-new-form">
                            <Button className="card-btn" sx={{color:"#ffffff", border:"1px solid #ffffff", borderRadius:"15px"}} onClick={() => navigate("/forms")}>
                              {t("qualitySite.Create_form")}
                            </Button>
                          </Box>
                        </Box>
                      ...
                      <li style={{ marginBottom: "10px" }}>
                        <Box className="list-item item-3 d-flex justify-content-between align-items-center">
                          ...
                          <Box className="col-lg-3 justify-content-center col">
                            <Button className="card-btn" sx={{color:"#ffffff", border:"1px solid #ffffff", borderRadius:"15px"}} onClick={() => navigate("/forms_report")}>
                              {t("qualitySite.View_reports")}
                            </Button>
                          </Box>
                        </Box>
                ...
                <Box className="col-12 col-lg-4 col-sm-12">
                  <Card className="outstanding-card extern">
                    <CardContent className="card-body div-title">
                      <Typography variant="h5">{t("qualitySite.Monitoring_forms")}</Typography>
                      <Box className="row">
                        <Box className="col-12">
                        ...
                        <Box className="row">
                          <Box sx={{ width: "100%" }}>
                            {topAgentes.length > 0 ? (
                              ...
                              <MenuItem disabled>No hay agentes críticos</MenuItem>
                            )}
                          </Box>
                        </Box>
                      </Box>
