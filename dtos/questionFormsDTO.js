...
class QuestionFormsDTO {
  static async validateQuestionForm(data) {
    ...
    if (isNaN(numBlockId) || !Number.isInteger(numBlockId)) {
      return {
        status: false,
        message: "Se debe ingresar un Id debloque valido",
      };
    }
    ...
    if (!existBlock) {
      return {
        status: false,
        message: "El bloque no existe, ingrese un bloque valido",
      };
    }
    ...
    for (const pregunta of preguntas) {
      ...
      if (
        ...
        return {
          status: false,
          message: "El titulo debe ser un texto y no puede estar vacio",
        };
      }
      ...
      if (
        ...
        return {
          status: false,
          message: "El conditional debe ser un texto y no puede estar vacio",
        };
      }
